...
$query = "SELECT * FROM all_data_products WHERE category = 'Personals' AND status = 'active'";
...
<head>
    ...
    <title>SHUSHRUTA - Personal's Care</title>
...
<div class="container mt-5">
    <h1><span>Personal's</span> Care</h1>
    <div class="row justify-content-center">
        <?php if (empty($products)) : ?>
            <p class="text-center text-muted">No Personal Care products available.</p>
        <?php else : ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-center gap-2">
                                ...
                                <form method="post" action="add_to_cart.php">
                                    ...
                                    <button type="submit" class="btn btn-success l px-3 shadow-sm">
