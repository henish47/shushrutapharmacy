...
$query = "SELECT * FROM all_data_products WHERE category = 'Drinks' AND status = 'active'";
...
<head>
    ...
    <title>SHUSHRUTA - Drinks's Care</title>
...
<div class="container mt-5">
    <h1><span>Drinks's</span> Care</h1>
    <div class="row justify-content-center">
        <?php if (empty($products)) : ?>
            <p class="text-center text-muted">No Drinks Care products available.</p>
        <?php else : ?>
