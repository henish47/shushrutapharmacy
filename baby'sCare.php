...
$query = "SELECT * FROM all_data_products WHERE category = 'Babys' AND BINARY status = 'active'";
...
<div class="container mt-5">
    <h1><span>Baby's</span> Care</h1>
    <div class="row">
        <?php if (empty($products)) : ?>
            <p class="text-center text-muted">No Baby Care products available.</p>
        <?php else : ?>
...
<script>
function toggleWishlist(form, productId) {
    ...
    .then(data => {
        ...
        if (data.includes("added")) {
            ...
            alert(data); // Show unexpected errors
        }
    })
